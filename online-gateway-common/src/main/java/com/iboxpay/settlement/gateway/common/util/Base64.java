...
public class Base64 {
    ...
    public static String encodeString(String s, boolean breakLines) {
        ...
        try {
            bytes = s.getBytes(DEFAULT_CHARSET_NAME);
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            return null;
        }

        return encodeBytes(bytes, breakLines);
    } // end encodeString
    ...
    public static String decodeToString(String s, String charsetName) throws UnsupportedEncodingException {

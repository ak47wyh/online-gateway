...
<thead>
<tr><th>交易账户</th><th width="50%">配置值</th></tr>
</thead>
<tr><td style="border-bottom:1pt solid black;" colspan="2"></td></tr>
<tr><td>通道账户名称：</td><td><input name="appCode"  value="${paymentMerchant.appCode }" class="txt_input"/></td></tr>
<tr><td>AppId：</td><td><input name="appId" value="${paymentMerchant.appId }"  class="txt_input"/></td></tr>
<tr><td>appSecret：</td><td><input name="appSecret" value="${paymentMerchant.appSecret }"  class="txt_input"/></td></tr>
...
<tr><td>交易商户号：</td><td><input name="payMerchantNo" value="${paymentMerchant.payMerchantNo }" class="txt_input" /></td></tr>
<tr><td>交易子商户号：</td><td><input name="payMerchantSubNo" value="${paymentMerchant.payMerchantSubNo }" class="txt_input"/></td></tr>

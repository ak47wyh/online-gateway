...
@Service
public class QueryPayment_Wechat implements IQueryPayment{
	private static Logger logger = LoggerFactory.getLogger(QueryPayment_Native.class);
	private final static String TRANS_CODE_QUERY= "queryWechatPay";
	private final static String TRANS_CODE_QUERY_DESC= "微信支付查询";
	...
	public void query(PaymentEntity[] payments) throws BaseTransException, IOException {
		...
		if(appType.equals(WeChatContrants.PAY_TYPE_NATIVE) || appType.equals(WeChatContrants.PAY_TYPE_JSAPI)){//扫码支付
